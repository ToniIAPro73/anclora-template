...
Definir cómo usar GSD y OpenSpec (ai-specs) en este repo siguiendo el Playbook SDD de Anclora.
...
4. Ejecutar GSD/agents usando estos artefactos como entrada.
...
- Mantener specs delta junto a la spec base.

## 3. Integración con Memanto y Bóveda

- Toda decisión estratégica se refleja en Bóveda (contratos, planes, dashboard Real Estate).
